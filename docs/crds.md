...
- [keycloak.osc.edu/v1alpha2](#keycloakosceduv1alpha2)
...
## KeycloakClient
<sup><sup>[↩ Parent](#keycloakosceduv1alpha2 )</sup></sup>
...
<table>
    ...
    <tbody><tr>
      <td><b>apiVersion</b></td>
      <td>string</td>
      <td>keycloak.osc.edu/v1alpha2</td>
      <td>true</td>
      </tr>
      <tr>
      <td><b>kind</b></td>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#keycloakclientstatusconditionsindex-1">conditions</a></b></td>
        <td>[]object</td>
        <td>
          conditions represent the current state of the KeycloakClient resource.
Each condition has a unique type and reflects the status of a specific aspect of the resource.
...
### KeycloakClient.status.conditions[index]
<sup><sup>[↩ Parent](#keycloakclientstatus-1)</sup></sup>
