...
func (d *KeycloakClientDefaulter) Default(_ context.Context, obj *keycloakv1alpha2.KeycloakClient) error {
...
func (d *KeycloakClientDefaulter) defaultSecret(obj *keycloakv1alpha2.KeycloakClient) {
...
func (d *KeycloakClientDefaulter) defaultConfigMap(obj *keycloakv1alpha2.KeycloakClient) {
...
func (v *KeycloakClientValidator) validateKeycloakClient(obj *keycloakv1alpha2.KeycloakClient) error {
...
func (v *KeycloakClientValidator) validateSecret(obj *keycloakv1alpha2.KeycloakClient) field.ErrorList {
	var allErrs field.ErrorList
	if obj.Spec.Secret == nil {
...
func (v *KeycloakClientValidator) validateConfigMap(obj *keycloakv1alpha2.KeycloakClient) field.ErrorList {
	var allErrs field.ErrorList
	if obj.Spec.ConfigMap == nil {
...
func (v *KeycloakClientValidator) validateProtocolMappers(obj *keycloakv1alpha2.KeycloakClient) field.ErrorList {
	var allErrs field.ErrorList
...
func (v *KeycloakClientValidator) ValidateCreate(_ context.Context, obj *keycloakv1alpha2.KeycloakClient) (admission.Warnings, error) {
...
func (v *KeycloakClientValidator) ValidateUpdate(_ context.Context, oldObj, newObj *keycloakv1alpha2.KeycloakClient) (admission.Warnings, error) {
...
func (v *KeycloakClientValidator) ValidateDelete(_ context.Context, obj *keycloakv1alpha2.KeycloakClient) (admission.Warnings, error) {
