...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KeycloakClientConfigMap) DeepCopyInto(out *KeycloakClientConfigMap) {
	*out = *in
	if in.Name != nil {
	...
	if in.KeycloakUrlKey != nil {
		in, out := &in.KeycloakUrlKey, &out.KeycloakUrlKey
		*out = new(string)
		**out = **in
	}
	if in.KeycloakHostKey != nil {
		in, out := &in.KeycloakHostKey, &out.KeycloakHostKey
		*out = new(string)
		**out = **in
	}
	if in.IssuerUrlKey != nil {
		in, out := &in.IssuerUrlKey, &out.IssuerUrlKey
		*out = new(string)
		**out = **in
	}
	if in.ProviderUrlKey != nil {
		in, out := &in.ProviderUrlKey, &out.ProviderUrlKey
		*out = new(string)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KeycloakClientConfigMap.
func (in *KeycloakClientConfigMap) DeepCopy() *KeycloakClientConfigMap {
	if in == nil {
		return nil
	}
	out := new(KeycloakClientConfigMap)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KeycloakClientProtocolMapper) DeepCopyInto(out *KeycloakClientProtocolMapper) {
	*out = *in
	...
	if in.IDTokenClaim != nil {
		in, out := &in.IDTokenClaim, &out.IDTokenClaim
		*out = new(bool)
		**out = **in
	}
	if in.AccessTokenClaim != nil {
		in, out := &in.AccessTokenClaim, &out.AccessTokenClaim
		*out = new(bool)
		**out = **in
	}
