...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KeycloakClientChecksum) DeepCopyInto(out *KeycloakClientChecksum) {
	*out = *in
	if in.Kind != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KeycloakClientChecksum.
func (in *KeycloakClientChecksum) DeepCopy() *KeycloakClientChecksum {
	if in == nil {
		return nil
	}
	out := new(KeycloakClientChecksum)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KeycloakClientSpec) DeepCopyInto(out *KeycloakClientSpec) {
	*out = *in
	...
	if in.ChecksumRef != nil {
		in, out := &in.ChecksumRef, &out.ChecksumRef
		*out = new(KeycloakClientChecksum)
		(*in).DeepCopyInto(*out)
	}
}
